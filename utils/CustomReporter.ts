...
class CustomTTAReporter implements Reporter {
    ...
    // Media filenames must use a per-test index. testCounter is bumped in
    // onTestBegin, so under fullyParallel it has already advanced past this
    // test by the time onTestEnd runs, and every test would clobber the last
    // one's screenshots, video and trace.
...
<body>
    ...
    <footer class="report-footer">
        <p>Built with ❤️ by <a target="_blank">Santosh</a> | <a target="_blank">Happy Testing</a></p>
    </footer>
